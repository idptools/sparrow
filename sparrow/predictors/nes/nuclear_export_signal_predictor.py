...
class NESPredictor():
    ...
    Class that loads in a network such that nuclear export signals can be predicted.
    ...
    def predict_nuclear_export_signal(self, seq):
        """
        Function to predict the presence of nuclear export signals. Returns a per
        residue probability score of a residue being in an NES or not
        ...
        np.ndarray
            ...
            gives the prediction of that residue being an NES
