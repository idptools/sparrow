...
## CHANGE class name
class PrefactorPredictor():
    """

    Class that loads in a network such that predict_prefactor() can be called to predict
    the prefactor from a sequence.
    ...
    def __init__(self, version=None):
        ...
        saved_weights = sparrow.get_data(f'networks/prefactor/prefactor_network_v{version}.pt')
    ...
    def predict_prefactor(self, seq):
        ...
        ----------
        float
            Returns a float where the predicted value is the prefactor
