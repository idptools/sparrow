...
## CHANGE class name
class ScalingExponentPredictor():
    """

    Class that loads in a network such that predict_scaling_exponent() can be called to predict
    the scaling_exponent from a sequence.
    ...
    def __init__(self, version=None):
        ...
        the ability to pass a string as version. This string is inserted at position <X> in the filename
            ...
            scaling_exponent_network_v<X>.pt
        ...
        saved_weights = sparrow.get_data(f'networks/scaling_exponent/scaling_exponent_network_v{version}.pt')
