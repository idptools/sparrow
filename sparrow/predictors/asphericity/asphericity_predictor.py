...
## CHANGE class name
class AsphericityPredictor():
    """

    Class that loads in a network such that predict_asphericity() can be called to predict
    the asphericity from a sequence.
    ...
    def __init__(self, version=None):
        ...
        saved_weights = sparrow.get_data(f'networks/asphericity/asphericity_network_v{version}.pt')
        ...
        # assuming the file is there, we next read in the parameter file. Note that we force this to be CPU mainly because
    ...
    def predict_asphericity(self, seq):
        ...
        np.ndarray
            ...
            predicted value for the asphericity.
