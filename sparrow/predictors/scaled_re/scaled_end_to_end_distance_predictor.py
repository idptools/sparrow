...
## CHANGE class name
class ScaledRePredictor():
    """

    Class that loads in a network such that predict_re() can be called to predict
    the end_to_end distance from a sequence.
    ...
    def __init__(self, version=None):
        ...
        saved_weights = sparrow.get_data(f'networks/scaled_re/scaled_re_network_v{version}.pt')
